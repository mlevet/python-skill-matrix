...
## Step 1 — Pick from review queue

Open [matrix/review_queue.md](matrix/review_queue.md).

Take the top item. Do not decide manually unless the queue is empty.
...
Open the matching drill file in [drills/](drills/). Do one small coding exercise.

---

## Step 5 — Update matrix

In [matrix/skill_matrix.md](matrix/skill_matrix.md), update:

- **Mastery** — adjust up or down based on how it went
- **Freshness** — set to Fresh
